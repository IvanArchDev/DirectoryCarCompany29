...
public class AlarmAndMedia extends Fragment {
    private static final int LAYOUT = R.layout.fragment_alarm_media;
    private View mView;
    ...
    public AlarmAndMedia() {
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mData = FirebaseDatabase.getInstance().getReference().child("MediaCompany");
    }
